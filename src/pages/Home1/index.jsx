    ...
    <>
      <div className='flex flex-col font-roboto items-center justify-start mx-auto w-full'>
        <div className='bg-white-A700 flex flex-col items-center justify-start w-full'>
          ...
          <HomeCta className='bg-white-A700 flex flex-col font-lato gap-20 items-center justify-start px-16 sm:px-5 sm:py-14 py-28 w-full' />
          <HomeGallery className='bg-white-A700 flex flex-col md:gap-10 gap-20 items-center justify-start  md:px-10 px-16 sm:px-5 sm:py-14 py-28 w-full h-full' />
